        ...
        <div className='instructorListingSection'>
            <div className="cards myClasses">
                <div className="heading flex">
                    <h1>My Classes</h1>
                    <button onClick={() => handleNavigate('/profile/my-classes')} className="btn flex">
            ...
            <div className="cards todaySchedule flex">
                <div className="schedule">
                    <div className="heading flex">
                        ...
                        <button onClick={() => handleNavigate('/profile/attendance')} className="btn flex">
                            See All <BsArrowRightShort className='icon' />
                        </button>
                    </div>
                    ...
                    <div className="singleCard flex">
                        ...
                        <button onClick={() => handleNavigate('/profile/attendance')} className="btn">Check In Now</button>
                    </div>
